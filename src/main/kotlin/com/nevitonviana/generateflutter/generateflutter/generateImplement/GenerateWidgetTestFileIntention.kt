...
class GenerateWidgetTestFileIntention : HelperCreateTestFile(), IntentionAction {

    @IntentionName
    override fun getText(): String = "Create or open widget test file"

    override fun createTestFile(project: Project, filename: String, psiDirectory: PsiDirectory) {
        val templateManager = FileTemplateManager.getInstance(project)
        val template = templateManager.getInternalTemplate("Dart Widget Test File")
